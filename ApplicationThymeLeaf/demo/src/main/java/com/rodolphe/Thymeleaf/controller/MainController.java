...
import com.rodolphe.Thymeleaf.model.Person;
...
public class MainController {
    ...
    static {
        persons.add(new Person(1,"Merlin", "Mage"));
        persons.add(new Person(2,"Oz", "Mage"));
        persons.add(new Person(3,"Achille", "Guerrier"));
        persons.add(new Person(4,"Brutus", "Guerrier"));
    }
